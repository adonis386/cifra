# -*- coding: utf-8 -*-
{
    ...
    'depends': ['base', 'base_vat', 'base_address_extended', 'l10n_ve', 'contacts', 'account','account_accountant', 'account_debit_note', 'sale', 'purchase','stock', 'product','account_batch_payment'],
    'data': [
        ...
        'views/account_wh_municipal_docs.xml',
        'views/account_batch_payment.xml',
        'views/res_bank.xml',
        'views/account_wh_municipal_txt.xml',
        'data/account_wh_muni_sequence.xml',
    ],
    "license": "GPL-2",
    "price": 3500,
    "currency": "USD",
