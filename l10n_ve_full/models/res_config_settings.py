...
class ResConfigSettings(models.TransientModel):
    ...
    partner_seniat_id = fields.Many2one('res.partner', string='Contacto SENIAT',
                                        help='Contacto SENIAT para generar los pagos de retención',
                                        related="company_id.partner_seniat_id", readonly=False)
