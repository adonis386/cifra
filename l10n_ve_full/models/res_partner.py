...
class ResPartner(models.Model):
    ...
    tipo_contribuyente_mun = fields.Selection([
        ('D', 'Domiciliado'),
        ('T', 'Transeúnte')], string="Tipo de Contribuyente Municipal", default='D')
    licencia_municipal = fields.Char('Licencia Municipal')
    codigo_asignado = fields.Char('Código Asignado Administración Tributaria', help='Código asignado por la Administración Tributaria para generar el txt de pagos')
