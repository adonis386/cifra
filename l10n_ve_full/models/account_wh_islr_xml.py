...
class IslrXmlWhDoc(models.Model):
    ...
    def action_generate_line_xml(self):
        ...
        # to set date_ret if don't exists
        obj_ixwl = self.env['account.wh.islr.xml.line']
        if self.invoice_xml_ids:
            self.invoice_xml_ids.write({'islr_xml_wh_doc': False})
    ...
    def _xml(self):
        ...
        for ixwd_id in self.ids:
            ...
            for line in xml_lines:
                ...
                SubElement(detalle, "RifRetenido").text = partner_vat.replace("-", "")
    ...
    def generate_pay(self):
        ...
        account_id = self.company_id.partner_id.purchase_islr_journal_id.default_islr_account
